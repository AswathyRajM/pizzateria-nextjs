    ...
    <PageLayoutWrapper>
        ...
        <AnimatePresence>
          ...
          >
            ...
            <p className="mt-4 leading-relaxed">
              ...
              where families, friends, and food lovers gather. Our secret?
              Staying true to the heart of pizza-making: fresh ingredients,
              honest flavors, and a lot of love.
            </p>
          </motion.div>
        </AnimatePresence>
      ...
      >
        <section className="text-center text-white">
          ...
          <button className="px-8 py-3 font-medium bg-yellow-500 text-black rounded-lg shadow-md transition duration-200 hover:bg-red-600 hover:text-white">
            Order Now
          </button>
        </section>
      </motion.div>
